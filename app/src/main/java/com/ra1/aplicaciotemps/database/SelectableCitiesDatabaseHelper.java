package com.ra1.aplicaciotemps.database;
...
public class SelectableCitiesDatabaseHelper extends SQLiteOpenHelper {
    private static final String DB_NAME = "cities.db";
    private final File DB_PATH;
    private final Context context;

    public SelectableCitiesDatabaseHelper(Context context) {
