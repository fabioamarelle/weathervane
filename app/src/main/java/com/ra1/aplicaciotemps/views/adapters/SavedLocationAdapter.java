package com.ra1.aplicaciotemps.views.adapters;
...
public class SavedLocationAdapter extends RecyclerView.Adapter<SavedLocationAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_saved_location, parent, false);
    ...
    private void updateFavoriteIcon(MyViewHolder holder, boolean isFavorite) {
        if (isFavorite) {
            holder.favoriteButton.setImageResource(R.drawable.icon_favorite_on);
        } else {
            holder.favoriteButton.setImageResource(R.drawable.icon_favorite_off);
        }
    }
    ...
    private void fetchWeather(ArrayList<String> coordinates, MyViewHolder holder) {
        ...
        new Thread(() -> {
            try {
                String result = Weather.getWeather(coordinates, unit, lang);
    ...
    private void updateBackground(MyViewHolder holder, String clima) {
        int drawableId;
        switch (clima) {
            case "Clear": drawableId = R.drawable.card_background_clear; break;
            case "Rain":
            case "Drizzle":
            case "Thunderstorm": drawableId = R.drawable.card_background_rain; break;
            default: drawableId = R.drawable.card_background_cloudy; break;
        }
